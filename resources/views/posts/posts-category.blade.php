...
<div class="container-fluid" style="background-color: rgb(201, 219, 122); padding-bottom: 10px;">
  ...
  <div class="col-md-12">
    ...
    <div class="row row-cols-1 row row-cols-md-2 g-1 d-flex justify-content-between">
      ...
      <div class="card m-1 mb-3 pb-3 pt-3" style="background-color: lightblue; border-radius: 0.5em">
      @else
      <div class="card m-1 mb-3 pb-3 pt-3" style="background-color: lightpink; border-radius: 0.5em">
      @endif
        <div class="card-body">
